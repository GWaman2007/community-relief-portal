    ...
    <div className="min-h-screen bg-background flex flex-col relative overflow-hidden p-6">
      ...
      <div className="w-full max-w-7xl mx-auto flex flex-col gap-6 z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <Card className="col-span-1 lg:col-span-2 bg-card/60 backdrop-blur-xl border-border/50 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-[transform,box-shadow] duration-300 overflow-hidden flex flex-col">
          ...
          <div className="col-span-1">
            <Card className="bg-card/60 backdrop-blur-xl border-border/50 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-[transform,box-shadow] duration-300 h-full flex flex-col items-center justify-center text-center p-8">
               ...
               <Button onClick={() => router.push("/report")} size="lg" className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-bold h-12 shadow-lg shadow-primary/20 transition-colors">
                 Launch Field Report
               </Button>
            </Card>
          </div>
