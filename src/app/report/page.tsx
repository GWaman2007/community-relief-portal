  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden" aria-hidden="true">
        <div className="absolute top-[-10%] right-[10%] w-[40vw] h-[40vh] rounded-full bg-cyan-500/10 blur-[120px]" />
        <div className="absolute bottom-[-10vh] left-[-10vw] w-[30vw] h-[30vh] rounded-full bg-blue-500/10 blur-[120px]" />
      </div>
